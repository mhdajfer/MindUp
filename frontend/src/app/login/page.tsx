...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      if (data.success) {
        dispatch(userLogin({ user: data.user, token: data.data }));
  ...
  return (
    <motion.div
      className="flex min-h-screen items-center justify-center bg-gradient-to-br from-violet-50 to-purple-100 dark:from-violet-950 dark:to-purple-900 p-4"
      initial="hidden"
      animate="visible"
